...
- Figma MCP server must be connected and accessible (`.cursor/mcp.json` → `https://mcp.figma.com/mcp`; OAuth na primeira vez)
...
**Neste repositório:** ler [projeto.md](projeto.md) e `.cursor/skills/frontend-design/SKILL.md` antes de codar.
